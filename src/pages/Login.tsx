...
const PROVIDERS = [
  ...
  },
  {
    ...
    label: 'Discord',
    icon: (
      <svg viewBox="0 0 24 24" width="22" height="22" fill="#5865F2" xmlns="http://www.w3.org/2000/svg">
    ...
    border: 'border-[#5865F2]/20 hover:border-[#5865F2]/50',
  },
] as const;
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-muted">Выберите удобный способ входа</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          {PROVIDERS.map((p) => (
            <button
              ...
              className={`flex w-full items-center gap-3 rounded-xl border bg-white/5 px-5 py-3.5 text-sm font-medium text-fg transition-all hover:bg-white/10 ${p.border}`}
            >
              {p.icon}
